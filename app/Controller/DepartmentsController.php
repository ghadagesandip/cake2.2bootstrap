 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Department->save($this->request->data)) {
				...
				$dept_data=$this->Department->find('first',array('conditions'=>array('Department.id'=>$id)));
	...
	public function _sendEmail($message,$to,$subject){

		        $headers = "From: WWISE <wwiseemailagent@gmail.com>\r\n".
			               "MIME-Version: 1.0" . "\r\n" .
